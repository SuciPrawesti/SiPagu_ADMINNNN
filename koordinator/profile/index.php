<?php
/**
 * PROFILE KOORDINATOR - SiPagu
 * Halaman untuk mengelola profile koordinator
 * Lokasi: koordinator/profile/index.php
 */
                                ...
                                <div class="col-md-8">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-group text-right">
                                            <a href="<?= BASE_URL ?>koordinator/index.php" class="btn btn-secondary mr-2">
