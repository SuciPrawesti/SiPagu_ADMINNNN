                ...
                <div class="col-lg-8 mb-4">
                    <div class="content-card content-card-primary">
                        <div class="card-header-simple">
                            ...
                            <a href="<?= BASE_URL ?>admin/master_data/data_tu.php" class="text-primary small">View All</a>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="info-item mt-3 pt-2 border-top">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span class="font-weight-medium text-primary"><?php echo ucfirst($_SESSION['role'] ?? 'Administrator'); ?></span>
                                </div>
                            </div>
                            <div class="info-item">
                                <div class="d-flex justify-content-between">
            ...
            <div class="row mt-2">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="content-card content-card-primary">
                        ...
                        <div class="card-body">
                            <?php foreach (['staff' => 'primary','admin' => 'success','koordinator' => 'warning'] as $role => $col):
                ...
                <div class="col-lg-7 mb-4">
                    <div class="content-card content-card-info">
                        <div class="card-header-simple">
                            ...
                            <a href="<?= BASE_URL ?>admin/master_data/data_thd.php" class="text-primary small">View All</a>
                        </div>
                        <div class="card-body p-0">
                            <div class="activity-list">
