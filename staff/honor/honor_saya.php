...
// Simpan semua data ke array agar pointer tidak habis
$honor_rows = [];
while ($r = mysqli_fetch_assoc($query)) {
    $honor_rows[] = $r;
}

// Hitung total honor dari array
$total_honor_rupiah = 0;
foreach ($honor_rows as $r) {
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <?php if ($total_data > 0): ?>
                                            <?php $no = 1; foreach ($honor_rows as $row): 
...
$(document).ready(function() {
    $('table.table-hover').DataTable({
        ...
        "language": {
            ...
            "zeroRecords": "Tidak ada data honor",
