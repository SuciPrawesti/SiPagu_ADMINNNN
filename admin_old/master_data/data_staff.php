<?php
/**
 * MASTER DATA STAFF - SiPagu
 * Lokasi: admin/master_data/data_staff.php
 * Fungsi: Read, Update, Delete data staff
 */
...
if (isset($_GET['delete_id'])) {
    ...
    if ($has_relations) {
        $_SESSION['message'] = 'Data staff tidak dapat dihapus karena masih digunakan di tabel lain.';
        $_SESSION['message_type'] = 'danger';
    } else {
        $delete_query = mysqli_query($koneksi, 
            "DELETE FROM t_user WHERE id_user = $id_to_delete AND role_user = 'staff'"
        );
...
if (isset($_GET['edit_id'])) {
    ...
    $edit_result = mysqli_query($koneksi, 
        "SELECT * FROM t_user WHERE id_user = $edit_id AND role_user = 'staff'"
    );
...
if (isset($_POST['update_staff'])) {
    ...
    $update_query = mysqli_query($koneksi, 
        ...
        WHERE id_user = $id_user AND role_user = 'staff'"
    );
    
    if ($update_query) {
        $_SESSION['message'] = 'Data staff berhasil diperbarui.';
        $_SESSION['message_type'] = 'success';
        header("Location: data_staff.php");
        exit();
    } else {
        $message = 'Gagal memperbarui data staff: ' . mysqli_error($koneksi);
        $message_type = 'danger';
    }
}
...
$query = mysqli_query($koneksi, 
    "SELECT * FROM t_user WHERE role_user = 'staff' ORDER BY nama_user ASC"
);
...
// Hitung total staff
$total_query = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM t_user WHERE role_user = 'staff'");
$total_data = mysqli_fetch_assoc($total_query);
$total_staff = $total_data['total'];
?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="edit-form-container">
                                ...
                                <form method="POST" action="" class="edit-form">
                                    ...
                                    <div class="form-group text-right">
                                        <a href="data_staff.php" class="btn btn-secondary">Batal</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="table-staff">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>NPP</th>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <a href="?delete_id=<?= $row['id_user'] ?>" 
                                                       ...
                                                       onclick="return confirm('Yakin ingin menghapus data staff <?= htmlspecialchars($row['nama_user']) ?>?')">
                                        ...
                                        <tr>
                                            <td colspan="9" class="text-center">
                                                <?= $message ? $message : 'Tidak ada data staff' ?>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                    </tbody>
